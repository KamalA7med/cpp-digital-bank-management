...
public:
    ...
    float _GetAmount_In_USD(float Amount)
    {
        return Amount / this->Rate();
    }
     float _GetAmount_In_DestinationCurrency(clsCurrency DestionationCurrency,float Amount)
    {
        float Amount_In_USD = _GetAmount_In_USD(Amount);
        if (DestionationCurrency.CurrencyCode() == "USD")
        {
            return Amount_In_USD;
        }
        return (Amount_In_USD * DestionationCurrency.Rate());
    }
};
